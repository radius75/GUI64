...
Str_Tooltip_DrvA!pet "A:",0
Str_Tooltip_DrvB!pet "B:",0
Str_Title_Settings    
                !pet "Settings",0
...
Str_Mess_GUI64  !pet 221,222,223," GUI64 v",VERSION
                !pet "\",224,225,226," WebFritzi Inc.\    ",96," 2025",0
...
;------------------------------
; Sort Dialog
Wnd_Dlg_Sort    !byte WT_DLG_SORT, %00001100, 14, 8, 12, 4, <Str_Dlg_GUI64, >Str_Dlg_GUI64, <EmptyWndProc, >EmptyWndProc
                !byte CT_LABEL, 1, 1, 10, 1
                !pet "Sorting...",0
                ; Final zero byte
                !byte 0
;------------------------------
